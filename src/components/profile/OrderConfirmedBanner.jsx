        ...
        <div className={styles.banner} role="alert">
            <div className={styles.content}>
                ...
                <div className={styles.textGroup}>
                    <h3 className={styles.title}>{unreadNotification.title}</h3>
                    <p className={styles.description}>{unreadNotification.message}</p>
                </div>
            </div>

            <div className={styles.actions}>
                <Link
                    href={unreadNotification.link || '/profile/purchases'}
                    className={styles.actionBtn}
                    onClick={handleDismiss}
                >
                    مشاهده و شروع دوره‌ها
